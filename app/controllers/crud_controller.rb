...
class CrudController < ListController
  ...
  def create(options = {}, &block)
    ...
    respond_with(entry, options.reverse_merge(:success => created, :location=> index_url), &block)
  end
  ...
  def update(options = {}, &block)
    ...
    respond_with(entry, options.reverse_merge(:success => updated, :location=> index_url), &block)
  end
